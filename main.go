// Kibitz relay — a fixed-identity WebRTC responder (CLI front-end).
//
// A browser page may dial out over WebRTC without certificates, but it needs a
// signaling channel first. This relay removes that need by having a PERMANENT
...
// short blob; the web app reconstructs the relay's SDP "answer" locally from
